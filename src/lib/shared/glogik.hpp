...
extern c_str GLOGIK_DESKTOP_SERVICE_LAUNCHER_DBUS_BUS_CONNECTION_NAME;
	/* -- */
extern c_str GLOGIK_DESKTOP_SERVICE_LAUNCHER_SESSION_MESSAGE_HANDLER_DBUS_OBJECT;
extern c_str GLOGIK_DESKTOP_SERVICE_LAUNCHER_SESSION_MESSAGE_HANDLER_DBUS_OBJECT_PATH;
extern c_str GLOGIK_DESKTOP_SERVICE_LAUNCHER_SESSION_MESSAGE_HANDLER_DBUS_INTERFACE;
