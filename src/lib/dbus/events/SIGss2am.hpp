...
#ifndef SRC_LIB_DBUS_EVENTS_GKDBUS_EVENT_TYPE_SIG_SS2Am_HPP_
#define SRC_LIB_DBUS_EVENTS_GKDBUS_EVENT_TYPE_SIG_SS2Am_HPP_
...
template <>
	void callbackEvent<SIGss2am>::runCallback(
