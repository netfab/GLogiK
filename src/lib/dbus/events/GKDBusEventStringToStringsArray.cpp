...
void EventStringToStringsArray::addStringToStringsArrayEvent(
	const char* object,
	...
	GKDBusEvent* e = new StringToStringsArrayEvent(eventName, args, callback, eventType, introspectable);
