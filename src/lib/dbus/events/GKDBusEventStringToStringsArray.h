...
#ifndef __GLOGIK_GKDBUS_EVENT_STRING_TO_STRINGS_ARRAY_H__
#define __GLOGIK_GKDBUS_EVENT_STRING_TO_STRINGS_ARRAY_H__
...
class StringToStringsArrayEvent
 :
	public GKDBusEvent,
...
class EventStringToStringsArray
{
	public:
