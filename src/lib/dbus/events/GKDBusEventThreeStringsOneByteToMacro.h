...
#ifndef __GLOGIK_GKDBUS_EVENT_THREE_STRINGS_ONE_BYTE_TO_MACRO_H__
#define __GLOGIK_GKDBUS_EVENT_THREE_STRINGS_ONE_BYTE_TO_MACRO_H__
...
class EventThreeStringsOneByteToMacro
{
	public:
